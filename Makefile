#############################################################################
# Makefile for building: bin/mightygraph
# Generated by qmake (2.01a) (Qt 4.3.3) on: Sun Apr 6 00:17:49 2008
...
Makefile: mightygraph.pro  /usr/local/Qt4.3/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.3/mkspecs/common/unix.conf \
		...
		/usr/local/Qt4.3/mkspecs/features/debug_and_release.prf \
		...
		/usr/local/Qt4.3/mkspecs/features/mac/ppc.prf \
