...
<xsl:template match="/" priority="1">
	...
	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ev="http://www.w3.org/2001/xml-events" version="1.1" baseProfile="full" x="0" y="0" width="800" height="500" id="graphe">
		...
		<defs>
			<marker id="startArrow" viewBox="0 0 20 20" markerUnits="strokeWidth" refX="0" refY="10" markerWidth="10" markerHeight="10" orient="auto">
				<path d="M20,0 L0,10 20,20 z" style="fill:white;stroke:black;stroke-width:2"/>
			</marker>
			<marker id="endArrow" viewBox="0 0 20 20" markerUnits="strokeWidth" refX="20" refY="10" markerWidth="10" markerHeight="10" orient="auto">
				<path d="M0,0 L0,20 20,10 z" style="fill:black;stroke:black;stroke-width:2" />
			</marker>
		</defs>
